...
```
`replace` with `path: "members"` is a **full list replacement** — treat as: compute diff vs current `group_members`, add new, remove old. Same saga as Update Group step 4–5.
