...
As the SCIM bridge, want typed Pydantic models for User resources, so routers can parse Okta requests and serialize Brivo responses without ad-hoc dicts.
